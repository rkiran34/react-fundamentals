...
1. React.createElement can take in a function as argument and the function's arguments as the subsequent arguments

2. Extra Credit 2:
*  Using function name `message` caused child divs to display inline :confused:
* Using function name `Message` caused child divs to display as blocks
